...
include { iget_study_cram } from "$projectDir/modules/iget_study_cram.nf"

// include workflow common to all input modes:
include { run_from_irods_tsv } from "$projectDir/modules/run_from_irods_tsv.nf"

/*
========================================================================================
    HEADER with the pipeline vars
========================================================================================
*/
// params default
params.header = true
    ...
    if (params.run_mode == "study_id") {
        if (params.input_study_lanes) {
			...
			if (params.sample_name){
				log.info("input study - ${input_studies} -> sampleName - ${sample_name}")
